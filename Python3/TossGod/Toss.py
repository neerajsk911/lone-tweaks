...
class TossGod:
    ...
    def toss(self):
        ...
        while draw is True:
            ...
            if draw : print(f"\nDraw!({count_tails}/{count_heads})"+describerDraw()+f" Draw {ct_draw}!"); ct_draw+=1 
    ...
    def describerDraw(self):
        messages=[" Not a gud day to Draw! Lets go Again!"," Oh Drat! Go Again u Moron!"," Tough to Decide Eh!"," U better start figuring it out yourself!"]
